...
class FluxControlNetInpaintingPipeline(DiffusionPipeline, FluxLoraLoaderMixin):
    ...
    def __call__(
        ...
        if isinstance(self.controlnet, FluxControlNetModel):
            control_image, height, width = self.prepare_image_with_mask( # control_image:1, 2304, 68
                image=control_image,
                mask=control_mask,
                width=width,
                height=height,
        ...
        latents, latent_image_ids = self.prepare_latents( # latents:1, 2304, 64,     latent_image_ids:1, 2304, 3
            batch_size * num_images_per_prompt,
            num_channels_latents,
            height,
            width,
